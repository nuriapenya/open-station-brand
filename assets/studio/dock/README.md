...
Copied from the local Alcazaba plugin on 2026-09-09 for independent Theme Creator previews. These are data-only SVG assets; no shell runtime or plugin import is used. Original artwork is GPL-2.0-or-later, like the source plugin; see the GPL license in `vendor/alcazaba-ui/LICENSE`.
